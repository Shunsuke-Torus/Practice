...
def main():
    ...
    if(p_judge==0):
        p = sympy.randprime(pow(10,298),pow(10,299))#sympy.randprime(a,b)a以上b未満の素数を返す。未満だったので300と書いてもok
    else:
        p = p_judge
        
    if(q_judge==0):
        q = sympy.randprime(pow(10,298),pow(10,299))
    else:
        q = q_judge
        
    while(p==q):
        p = sympy.randprime(pow(10,298),pow(10,299))
    #n
    n = p*q
