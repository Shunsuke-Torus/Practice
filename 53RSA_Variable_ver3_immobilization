...
def main():
    ...
    #別に固定化されてもいいのでは.299桁以上から300桁未満で秘密鍵をp,qを製作
    p = sympy.randprime(pow(10,299),pow(10,300))#10bitをしてしたとき2^10=1024(10)だが10000000000(2)と11bitになるしかし(2,bit)-1で1023となり1111111111(2)と10bitの最大値で計算できる。
    #q
    q = sympy.randprime(pow(10,299),pow(10,300))#sympy.randprime(a,b)a以上b未満の素数を返す。未満だったのでbitの形に戻す。
